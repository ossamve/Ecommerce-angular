...
import { AdminAuthGuardLogin, SellerAuthGuardService, SellerBuyerAuthGuardLogin } from './shared/services/auth-guard.service';
...
export const routes: Routes = [
  ...
  {
    path: '',
    canActivate:[BuyerDashboardComponent],
    children: [
